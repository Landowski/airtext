...
function simulateTyping() {
    ...
    const expandedText1 = `Aquí está el texto completo, transformado por el atajo del expansor de texto. Puedes poner tantos párrafos y palabras como quieras. Esto hace que sea muy fácil crear plantillas para sus respuestas.
    <br/><br/>`;
...
textareaTarget.addEventListener("input", function (event) {
    ...
    const atalho = "**prueba";
    const textoSubstituido = `Hola espero que estés bien!

Le escribo para demostrarle la cantidad de contenido que puedo dejar guardado de forma predefinida y luego ser reemplazado por un único acceso directo.

¡Espero que esta extensión pueda ahorrarte horas y horas escribiendo y hacerte producir mucho más en menos tiempo!

Un abrazo y espero tu instalación.
Airtext.net
